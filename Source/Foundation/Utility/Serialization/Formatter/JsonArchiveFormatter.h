...
class DLL_EXPORT JsonArchiveFormatter : public ArchiveFormatter {
private:
    Archive &mArchive;
    struct JsonArchiveFormatterInternal *mInternal;

public:
    JsonArchiveFormatter(Archive &archive);
    ~JsonArchiveFormatter() override;
