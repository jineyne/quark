...
#ifdef Foundation_BufferManager_g_h
#error "BufferManager.g.h already included. missing '#pragma once' in BufferManager.h"
#endif

#define Foundation_BufferManager_g_h

#undef CURRENT_FILE_ID
#define CURRENT_FILE_ID Foundation_Source_BufferManager_h
